const projects = [
  {
    ...
    description:
      "A multi-page coffee subscription website. Make selections to create a coffee subscription and see an order summary of your choices.",
  ...
  },
  {
    ...
    description:
      "A multi-page coffee marketing website. Showcasing who the customers are, how easy it is to work with this product and pricing plans. I took a mobile-first approach and used modern CSS like Flexbox and Grid for layout purposes.",
  ...
  },
  {
    ...
    title: "DevJobs Board",
    description:
      "A jobs board app using a local data.json to retrieve the data. Filter jobs by title, location, and whether a job is for a full-time position. Load more than the default 12 jobs by clicking the 'Load More' button.",
  ...
  {
    id: 4,
    title: "Boundless Car Care",
    description:
      "A full service auto detailing website I built for a client. Users are able to view all of the services offered and contact the business via a contact form.",
    link: "https://boundlesscarcare.com/",
    skills: "HTML, CSS, WordPress",
    image: "/images/Boundless-Car-Care.png",
    isFeatured: true,
  },
  {
    id: 5,
    ...
    skills: "HTML, CSS, JavaScript, Copy to clipboard",
  ...
  },
  {
    ...
    skills:
      "HTML, CSS, JavaScript, Handlebars, Express, NodeJS, SQL, Sequelize ORM",
